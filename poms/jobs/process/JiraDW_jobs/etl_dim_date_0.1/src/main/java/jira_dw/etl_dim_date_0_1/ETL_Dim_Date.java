...
package jira_dw.etl_dim_date_0_1;
 ...
 * @status
 */
public class ETL_Dim_Date implements TalendJob {
	...
	private final String jobName = "ETL_Dim_Date";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ETL_Dim_Date.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class opStruct implements routines.system.IPersistableRow<opStruct> {
		final static byte[] commonByteArrayLock_JIRA_DW_ETL_Dim_Date = new byte[0];
		static byte[] commonByteArray_JIRA_DW_ETL_Dim_Date = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_JIRA_DW_ETL_Dim_Date) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("MyDate=" + String.valueOf(MyDate));
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:howjfhzIqbTPTXRSEnUY+VNxR0/JoTMek8IhZzxdGefhKw==");
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID_Date\",\"Date\",\"Day\",\"Month\",\"Year\") VALUES (?,?,?,?,?)";
...
// ###############################
				...
				int nb_max_row_tRowGenerator_1 = 365;

				class tRowGenerator_1Randomizer {
					public java.util.Date getRandomMyDate() {

						return TalendDate.addDate(TalendDate.parseDate("yyyy-MM-dd", "2021-01-01"),
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					row1.MyDate = randtRowGenerator_1.getRandomMyDate();
...
// # Output table : 'op'
						op_tmp.ID_Date = Integer.parseInt(TalendDate.formatDate("ddMMyyyy", row1.MyDate));
						op_tmp.Date = row1.MyDate;
						op_tmp.Day = Integer.parseInt(TalendDate.formatDate("dd", row1.MyDate));
						op_tmp.Month = Integer.parseInt(TalendDate.formatDate("MM", row1.MyDate));
						op_tmp.Year = Integer.parseInt(TalendDate.formatDate("yyyy", row1.MyDate));
						op = op_tmp;
// ###############################
...
// Start of branch "op"
					if (op != null) {
						...
						pstmt_tDBOutput_1.setInt(1, op.ID_Date);

						if (op.Date != null) {
							pstmt_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(op.Date.getTime()));
						} else {
						...
						if (op.Day == null) {
							...
							pstmt_tDBOutput_1.setInt(3, op.Day);
						}

						if (op.Month == null) {
							pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
						} else {
							pstmt_tDBOutput_1.setInt(4, op.Month);
						}

						if (op.Year == null) {
							pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
						} else {
							pstmt_tDBOutput_1.setInt(5, op.Year);
						}
...
// ###############################      
	...
	public static void main(String[] args) {
		final ETL_Dim_Date ETL_Dim_DateClass = new ETL_Dim_Date();

		int exitCode = ETL_Dim_DateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ETL_Dim_Date.class.getClassLoader()
					.getResourceAsStream("jira_dw/etl_dim_date_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ETL_Dim_Date.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ETL_Dim_Date");
		}
...
/************************************************************************************************
 * 48908 characters generated by Talend Open Studio for Data Integration on the
 * 04 April 2021 16:36:28 WAT
 ************************************************************************************************/